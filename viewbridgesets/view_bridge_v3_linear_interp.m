...
sub=[lat_m long_m alt(1:size(lat_m,1))];
sub=sub(minVnI:maxVnI,:);
...
lat_m(minVnI:maxVnI)=new_sub(:,1);
long_m(minVnI:maxVnI)=new_sub(:,2);
alt(minVnI:maxVnI)=new_sub(:,3);
